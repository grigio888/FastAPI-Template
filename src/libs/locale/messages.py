"""
Localization - Messages - Metaclass.
...
class MessagesMetaClass(type):
    ...
    GENERIC_ERROR: ClassVar = {
        "en_us": "An error occurred while processing your request.",
        "pt_br": "Ocorreu um erro ao processar sua solicitação.",
    }
